...
const page = async () => {
  ...
  return (
    <div className='flex h-screen w-full'>
      <div className="flex-1 flex overflow-hidden dark:bg-[#651c2b55] bg-[#651c2b] relative justiy-center items-center" >
        <img 
        src="/redis-logo.svg" 
        alt= "Redis Logo"
        ...
        <div className="flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold">
            ...
            <p className="text-2xl md:text-3xl text-balance z-10">
                The <span className="bg-red-500 px-2 font-bold text-white">ULTIMATE</span> chat
            </p>
            <p className="text-2xl md:text-3x1 mb-32 text-balance z-10">
                You <span className="bg-green-500/90 font-bold px-2 text-white"> NEED TO </span> build
            </p>
            <AuthButtons />
            </div>
        </div>
      <div className='flex-1 relate overflow-hidden justify-center items-center hidden md:flex bg-noise'>
        <img
            src={"/hero-right.png"}
            alt="Hero Image"
            fill
